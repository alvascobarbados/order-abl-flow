      ...
      >
        ...
        >
          <span
            ...
            style={{
              backgroundColor: stock.dot,
              boxShadow: `0 0 0 3px ${stock.halo}`,
            }}
          />
          {stock.label}
        </span>
        ...
        <div className="mt-1 grid grid-cols-[78px_1fr] gap-1.5">
          ...
          {soldOut ? (
            <button
              type="button"
              disabled
              className="inline-flex h-[34px] cursor-not-allowed items-center justify-center rounded-[7px] bg-[#F1F4F8] text-[12px] font-semibold text-[#64748B]"
            >
              Notify
            </button>
          ) : (
            <button
              type="button"
              onClick={() => console.log("add", product.sku, qty)}
              className="inline-flex h-[34px] items-center justify-center gap-1 rounded-[7px] bg-[#0F2540] text-[12px] font-semibold text-white transition hover:bg-[#1A3556]"
            >
